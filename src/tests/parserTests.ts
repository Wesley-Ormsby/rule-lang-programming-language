...
export async function runParserTests() {
  ...
  // Defs
  await test("Expected identifier for global variable name", `def 8`, [], ["200005"]);
  await test(
  ...
  await test("Expected `[` to start the rule scope", `begin => 7`, [], ["200002"]);
  await test(
  ...
  await test("Expected `]` to end the value scope", `begin >> [ 1`, [], ["200004"]);
  await test(
  ...
  await test("Expected match operator after `end` pattern", `end 8`, [], ["200008"]);
  await test(
  ...
  await test("Expected rule operator after the pattern", `1 2 []`, [], ["200012"]);
  await test(
  ...
  await test("Expected `)` to end the pattern group", `1 ( 5 >>`, [], ["200015"]);
  await test(
  ...
  await test("Expected expression after `(`", `1 if 3 < () >> 7`, [], ["200027"]);
  await test("Expected `)` to end expression", `1 if 3 < (6 >> 6`, [], ["200028"]);
  await test(
